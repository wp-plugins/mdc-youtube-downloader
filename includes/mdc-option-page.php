...
class MDC_option_page{
	...
	public function mdc_option_page(){
		add_menu_page('MDC YouTube Downloader', 'YT Downloader', 'administrator', 'mdc-youtube-downloader', array($this, 'mdc_youtube_downloader_options'), plugins_url( '../images/icon.png', __FILE__), '61.25');
	}
...
$option_page = new MDC_option_page;